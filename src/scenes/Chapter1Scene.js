...
export default class Chapter1Scene extends DialogueChapterScene {
  ...
  onBackgroundCreate() {
    ...
    this.add.sprite(width * 0.24, height * 0.22, 'line_walk4', 0).setScale(1.1).setAlpha(0.35);
    this.add.sprite(width * 0.76, height * 0.22, 'bell_walk4', 0).setScale(1.1).setAlpha(0.35);
  }
}
